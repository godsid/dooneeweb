...
<html lang="th">
  ...
  <body>
      ...
      <section class="hl-slider container">
        ...
        <div id="slider-fix" class="flexslider">
          <ul class="slides">
            <li data-thumb="img/big-slide-01.jpg">
            ...
            <li data-thumb="img/big-slide-02.jpg">
            ...
            <li data-thumb="img/big-slide-03.jpg">
            ...
            <li data-thumb="img/big-slide-04.jpg">
            ...
            <li data-thumb="img/big-slide-05.jpg">
        ...
        <?php /*?><div id="carousel" class="flexslider">
          <ul class="slides">
            <li>
              <img src="img/big-slide-01.jpg" alt="">
            </li>
