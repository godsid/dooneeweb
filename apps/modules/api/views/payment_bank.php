...
#popup-payment-prepaidcard.overlay{background:url(http://doonee.tv/assets/img/bg-card-popup.png) 50% 0 no-repeat #5dc8d3!important;background-size:100%}
    ...
    <div class="z-login form-control">
        <fieldset>
          ...
          <style type="text/css">a img{width:120px;padding: 5px;}</style>
            ...
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/SCB')?>"><img src="<?=static_url("/img/bank/scb.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/TMB')?>"><img src="<?=static_url("/img/bank/tmb.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/TBANK')?>"><img src="<?=static_url("/img/bank/thanachart.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/BAY')?>"><img src="<?=static_url("/img/bank/krungsri.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/BBL')?>"><img src="<?=static_url("/img/bank/bangkok-bank.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/UOB')?>"><img src="<?=static_url("/img/bank/uob.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/KTB')?>"><img src="<?=static_url("/img/bank/KTB.png")?>" ></a>
            <a href="<?=base_url('/payment/atm/'.$package['package_id'].'/KBANK')?>"><img src="<?=static_url("/img/bank/kbank.png")?>" ></a>
            </li>
          </ul>
        </fieldset>
    </div>
