...
#popup-payment-prepaidcard.overlay{background:url(https://www.dooneetv.com/assets/img/bg-card-popup.png) 50% 0 no-repeat #5dc8d3!important;background-size:100%}
...
#popup-payment-creditcard{width:350px;}
</style>
...
<div id="popup-payment-creditcard" class="overlay thm-login"><a class="close"></a>
  ...
  <div class="_cd-col-xs-12-sm-6">
    <div class="z-login form-control">
      <form action="<?=base_url('/api/payment/creditcard/submit/')?>" method="post"  id="2c2p-payment-form">
        <fieldset>
          <legend class="hd"><i class="gly-log-in"></i> เลือกธนาคาร</legend>
          <ul class="section-regis">
            <li><label>หมายเลขบัตรเครดิต</label></li>
            <li>
              <input type="text" placeholder="xxxx-xxxx-xxxx-xxxx" class="_sf-col-xs-12" id="cardnumber" data-encrypt="cardnumber" value="" maxlength="16">
            </li>
            <li><label class="span12">วันหมดอายุ Ex.01/2014</label></li>
            <li>
               <input type="text" placeholder="MM" value="" class="_sf-col-xs-2 input-small" id="month" data-encrypt="month" maxlength="2"><span class="_sf-col-xs-1"> / </span>
               <input type="text" placeholder="YYYY" value="" class="_sf-col-xs-4 input-medium" id="year" data-encrypt="year" value="123" maxlength="4">
            </li>
            <li><label>ชื่อ-นามสกุล บนบัตร</label></li>
            <li>
            ...
            <li><label>หมายเลข cvv (หลังบัตร)</label>
              
            </li>
            <p class="btn-regis"> <img src="<?=static_url('/img/cvv.gif')?>" style="width:130px;position:absolute;left:140px;" ></p>
            <li>
              <input type="password" placeholder="CVV2/CVC2" class="_sf-col-xs-12 input-medium" id="cvv" data-encrypt="cvv" maxlength="4" autocomplete="off">
            </li>
    ...
    <div class="z-regis" style="border-left:none;">
      ...
      <p class="btn-regis"> <img src="<?=static_url('/img/visa-master.png')?>" width="200px" ></p>
      
    </div>
  </div>
</div>

<!--<a href="<?=base_url('/api/payment/success/748')?>">SUCCESS</a> <a href="<?=base_url('/api/payment/error/748')?>">ERROR</a>-->
