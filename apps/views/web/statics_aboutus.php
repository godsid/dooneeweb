  ...
  <?php include('menu.php'); ?>
      ...
      <section id="contents">
          ...
          <div class="container bx-about">
          	<h2><a href="<?=base_url('/aboutus')?>" title="เกี่ยวกับเรา">เกี่ยวกับเรา <i class="icon-double-angle-right"></i></a></h2>
            <div class="inner">
			<h3>บริการ ดูหนัง (Doonee.TV) คืออะไร?</h3>
            ...
            <p><img src="<?=static_url('/img/aboutus.jpg')?>" alt="about doone"></p>
            </div>
          </div>
